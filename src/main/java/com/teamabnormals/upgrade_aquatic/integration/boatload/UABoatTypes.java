...
public class UABoatTypes {
	public static final BoatloadBoatType DRIFTWOOD = BoatloadBoatType.register(BoatloadBoatType.create(new ResourceLocation(UpgradeAquatic.MOD_ID, "driftwood"), () -> UABlocks.DRIFTWOOD_PLANKS.get().asItem(), () -> UAItems.DRIFTWOOD_BOAT.get(), () -> UAItems.LARGE_DRIFTWOOD_BOAT.get(), null, null));
	public static final BoatloadBoatType RIVER = BoatloadBoatType.register(BoatloadBoatType.create(new ResourceLocation(UpgradeAquatic.MOD_ID, "river"), () -> UABlocks.RIVER_PLANKS.get().asItem(), () -> UAItems.RIVER_BOAT.get(), () -> UAItems.LARGE_RIVER_BOAT.get(), null, null));
